...
1. Make sure you name all your new file names, variable names, function names and class names using Pascal Case, except for built-in keywords in Python.
...
4. Always update main.py to utilize the updated code.
